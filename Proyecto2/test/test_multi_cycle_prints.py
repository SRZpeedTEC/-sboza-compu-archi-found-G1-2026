"""Traza de ejecucion del MultiCycleEngine para depuracion y validacion visual.

Muestra el estado del procesador ciclo a ciclo: etapa actual, PC, registros
intermedios (IR, A, B, ALUOut, MDR) y metricas acumuladas.
"""
...
# incluso en Windows. Decoder.py debe registrarse antes de importar src.core.
