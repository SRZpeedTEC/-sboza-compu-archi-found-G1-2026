...
class MultiCycleDatapathView(QWidget):
    ...
    def _draw_paths(self, painter: QPainter, active_modules: set[str]) -> None:
        paths = [
            ...
            ("alu_src_a_mux", "alu", [(1230, 201), (1260, 201), (1260, 246), (1296, 246)]),
            ("alu_src_b_mux", "alu", [(1230, 329), (1260, 329), (1260, 301), (1296, 301)]),
            ...
            ("immediate", "alu_src_b_mux", [(898, 421), (1174, 421), (1174, 369)]),
            ("pc", "control_unit", [(74, 218), (74, 84), (235, 84)]),
            ("control_unit", "adr_src_mux", [(300, 138), (226, 138), (226, 215)]),
            ("memory", "control_unit", [(415, 174), (415, 138)]),
            ("control_unit", "ir", [(565, 58), (631, 58), (631, 110)]),
            ("control_unit", "register_file", [(565, 98), (826, 98), (826, 174)]),
            ("control_unit", "alu_src_a_mux", [(565, 44), (1174, 44), (1174, 161)]),
            ("control_unit", "alu_src_b_mux", [(565, 30), (1174, 30), (1174, 289)]),
            ("control_unit", "result_src_mux", [(565, 76), (1738, 76), (1738, 228)]),
        ]
